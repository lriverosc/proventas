    ...
    public partial class InsProductos : Form
    {
        ...
        private void UpdateData()
        {
            try
            {
                ...
                MessageBox.Show("Se Modifico el Producto con Exito", "Sistema de ventas", MessageBoxButtons.OK, MessageBoxIcon.Information);
       ...
       //Evento Boton Aceptar
        ...
        private void cboxUnidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboxUnidad.Text == "ABARROTES")
            {
                varUnidad = 1;       
            }

            if (cboxUnidad.Text == "BEBIDAS")
            {

                varUnidad = 2; 
            }

            if (cboxUnidad.Text == "LACTEOS")
            {
                varUnidad = 3; 

            }

            if (cboxUnidad.Text == "BOTANA-FRITURA")
            {
                varUnidad = 4;

            }

            if (cboxUnidad.Text == "CEREALES")
            {
                varUnidad = 5;
            ...
            if (cboxUnidad.Text == "LIMPIEZA")
            {
                varUnidad = 7;

            }
            if (cboxUnidad.Text == "PANADERIA")
            {
                varUnidad = 8;

            }
            if (cboxUnidad.Text == "REFRIJERADOS")
            {
                varUnidad = 9;

            }
            if (cboxUnidad.Text == "TORTILLERIA")
            {
                varUnidad = 10;
